...
struct Solver{
    ...
    void solve(){
        ...
        ll tmp = 0;
        rep(i,N) if(chmax(tmp,lca0.dep[i])) al=i;

        LCA lcal(g,al);
        tmp = 0;
        rep(i,N) if(chmax(tmp,lcal.dep[i])) ar=i;
        ...
        while(Q--){
            ...
            //cout << lcal.dep[U] << " , " << lcar.dep[U] <<endl;
            ...
            if(lcal.dep[U]>=K){
                ...
                ll a =U;
                while(dd){
                    if(dd&1) a = lcal.par[a][ex];
                    dd >>= 1;
                    ex++;
                }
                cout<< a+1<<endl;

            }else if(lcar.dep[U]>=K){
                ll dd=K;
                ll ex=0;
                ll a =U;
                while(dd){
                    if(dd&1) a = lcar.par[a][ex];
                    dd >>= 1;
                    ex++;
                }                
                cout<< a+1<<endl;
